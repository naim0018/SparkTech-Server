...
const createOrderData = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${config_1.default.steadfast.baseUrl}/create_order`, Object.assign({ api_key: config_1.default.steadfast.apiKey }, payload), {
            headers: {
